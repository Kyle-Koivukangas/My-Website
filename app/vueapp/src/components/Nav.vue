            ...
            <div class="sidebar fixed-top" v-if="show">
                ...
                <div class="secondary-info">
                    <ul>
                        ...
                        <li><a class="secondary-link" target="_blank" href="https://www.quora.com/profile/Kyle-Koivukangas">Quora</a></li>
                        <li><a class="secondary-link" href="">PGP</a></li>
                        <li><a class="secondary-link" href="">BTC</a></li>
                    </ul>
                </div>
